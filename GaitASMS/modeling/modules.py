...
class BasicConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, bias=False, **kwargs):
...
class FocalConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), halving=0, bias=False, **kwargs):
        super(FocalConv2d, self).__init__()
        self.halving = halving
...
class DilatedConv3d(nn.Module):
    def __init__(self, in_channels, out_channels, dilation, kernel_size=(3, 3, 3), stride=(1, 1, 1), padding=(1, 1, 1), bias=False, **kwargs):
        super(DilatedConv3d, self).__init__()
        self.conv3d = nn.Conv3d(in_channels, out_channels, kernel_size=kernel_size,
                                stride=stride, padding=padding, dilation=dilation, bias=bias, **kwargs)
