...
* Model to be trained
>  * Args
>     * model : Model type, please refer to [Model Library](../GaitASMS/modeling/models) for the supported values.
...
>       - **others**: Please refer to [data.sampler](../GaitASMS/data/sampler.py) and [data.collate_fn](../GaitASMS/data/collate_fn.py)
